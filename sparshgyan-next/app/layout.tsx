...
export const metadata: Metadata = {
  ...
  keywords: ['accessibility', 'braille', 'live captions', 'gesture control', 'voice navigation', 'deaf', 'blind', 'inclusive'],
  authors: [{ name: 'UPES Team' }],
  openGraph: {
    title: 'Sparshgyan — Accessibility Without Limits',
    description: 'Real-time live captions, haptic Braille via Arduino, gesture control, and voice navigation.',
    type: 'website',
  },
}
