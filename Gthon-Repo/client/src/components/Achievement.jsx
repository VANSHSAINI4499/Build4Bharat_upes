...
const Achievement = () => {
    return (
        <section className='w-full bg-white py-24' aria-labelledby="achievements-heading">
            <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0'>

                <div className='flex flex-col justify-center '>
                    <h2 id="achievements-heading" className='md:leading-[72px] text-3xl font-bold'>Our <span className='text-[#20B486]'>Achievements</span></h2>
                    ...
                    <div className='grid grid-cols-2 py-16'>
                        ...
                        <div className='py-6 flex'>
                            ...
                            <div className='px-3'>
                                <h3 className='text-2xl font-semibold'>1,00,000+</h3>
                ...
                <img src={achievement} className="m-auto md:order-last  order-first" alt="Learner achievement statistics illustration" />
