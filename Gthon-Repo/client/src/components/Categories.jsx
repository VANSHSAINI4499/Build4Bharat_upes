...
const Categories = () => {
  return (
    <section className='w-full bg-[#F0FBF7] py-24' aria-labelledby="popular-categories-heading">
      <div className='md:max-w-[1480px] m-auto max-w-[600px]  px-4 md:px-0'>
        <h2 id="popular-categories-heading" className='md:leading-[72px] text-3xl font-bold'>Most <span className='text-[#20B486]'>Popular Categories</span></h2>
